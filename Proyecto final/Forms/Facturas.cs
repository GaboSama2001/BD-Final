...
namespace Proyecto_final
{
    public partial class Facturas : Form
    {
        ...
        private void ConfigurarCarrito()
        {
            ...
            dataGridViewCarrito.Columns.Add("Codigo", "Código");
        ...
        private void Recibos_Load(object sender, EventArgs e)
        {
            ...
            // TODO: esta línea de código carga datos en la tabla 'dbDataSet.Cliente' Puede moverla o quitarla según sea necesario.
            this.clienteTableAdapter.Fill(this.dbDataSet.Cliente);
            ...
            using (SqlConnection conn = db.GetConnection())
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction()) // Usar transacción para mayor seguridad
                {
                    try
                    {
                        ...
                        string queryRecibo = @"
                    INSERT INTO Recibo (Comprador, FechaHora, Monto)
                    OUTPUT INSERTED.Numero
                    VALUES (@Comprador, @FechaHora, @Monto)";
